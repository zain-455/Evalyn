        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IRT_Difficulty = table.Column<double>(type: "float", nullable: false),
                    IRT_Discrimination = table.Column<double>(type: "float", nullable: false),
                    IRT_Guessing = table.Column<double>(type: "float", nullable: false),
                    DifficultyLabel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    TimesAdministered = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ExamId = table.Column<int>(type: "int", nullable: false),
                    ThetaEstimate = table.Column<double>(type: "float", nullable: false),
                    ThetaSEM = table.Column<double>(type: "float", nullable: false),
                    PercentileRank = table.Column<double>(type: "float", nullable: false),
                    IntegrityScore = table.Column<double>(type: "float", nullable: false),
                    IntegrityLabel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionDomainTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionDomainTags_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BehavioralEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BehavioralEvents_TestSessions_TestSessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCorrect = table.Column<bool>(type: "bit", nullable: false),
                    ThetaAtTime = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BehavioralEvents_TestSessionId_EventType",
                table: "BehavioralEvents",
                columns: new[] { "TestSessionId", "EventType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionDomainTags_QuestionId_DomainName",
                table: "QuestionDomainTags",
                columns: new[] { "QuestionId", "DomainName" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestSessions_UserId_ExamId",
                table: "TestSessions",
