...
const strToFind = <div className="form-group" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                <label className="form-label" style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '0.75rem', display: 'block' }}>Assessment Engine</label>;

let pos = code.indexOf(strToFind);
if(pos === -1) { console.log('not found'); process.exit(1); }

let endStr = <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '1.5rem', marginTop: '1rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.05)' }}>;
let posEnd = code.indexOf(endStr, pos);
                ...
                <div style={{ display: 'flex', gap: '1rem', flex: 1 }}>       
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.75rem', margin: 0, marginTop: '0.4rem', lineHeight: '1.4' }}>Fixed sequence of questions.</div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.75rem', margin: 0, marginTop: '0.4rem', lineHeight: '1.4' }}>Questions scale to ability.</div>
                    </div>
                  </div>
                </div>
              </div>
...
code = code.substring(0, pos) + str + code.substring(posEnd);
